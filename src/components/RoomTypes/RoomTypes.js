        ...
        <div>
            <div className='container mt-5' id="test">
                <div>
                    ...
                    (index % 2 === 0 ? <div>  <div key={index} className='row mt-5  '>
                        ...
                        <div className='col-lg-6 col-md-6 col-sm-12 p-5'>
                            <div className=''>
                                ...
                                <button type="button" className="btn btn-warning " onClick={() => setBookingModel({ modal: true, details: item })}>Book Now</button>


                            </div>

                        </div>
                    </div></div> : <div>  <div key={index} className='row  my-margin-room' >
